...
export interface CreateDatasetEvaluatorParams extends ClientFn {
   ...
   * description of its prompt's tool function.
   */
   ...
   * For LLM evaluators the override must match the prompt's tool schema.
   */
 ...
 * @param params.outputConfigs - Optional output configuration overrides.
