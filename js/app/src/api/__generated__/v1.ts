...
export interface components {
    schemas: {
        ...
        CreateDatasetEvaluatorRequest: {
            ...
            /**
             * Output Configs
             * @description Null inherits the shared output configs. Code and built-in bindings may override with any configs, including []; LLM bindings must keep at least one categorical config that matches the prompt's tool schema.
             */
        ...
        PatchDatasetEvaluatorRequest: {
            ...
            /**
             * Output Configs
             * @description Omit to preserve; null restores inheritance. Code and built-in bindings may override with any configs, including []; LLM bindings must keep at least one categorical config that matches the prompt's tool schema.
             */
            output_configs?: (components["schemas"]["CategoricalAnnotationConfigData"] | components["schemas"]["ContinuousAnnotationConfigData"] | components["schemas"]["FreeformAnnotationConfigData"])[] | null;
        };
