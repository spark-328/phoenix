        ...
        *,
        ...
        Args:
            ...
            output_configs (Sequence[EvaluatorOutputConfig]): Overrides the shared
                definition's output configurations on this binding. For LLM
                evaluators the override must match the prompt's tool schema.
        ...
        *,
        ...
        Args:
            ...
            output_configs (Optional[Sequence[EvaluatorOutputConfig]]): New
                output configuration overrides, or ``None`` to inherit the shared
                definition's outputs again.
